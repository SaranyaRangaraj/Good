...
function Register(props) {  
  const [data, setdata] = useState({Id:'', Email: '', Password: '', EmployeeName: '', City: '', Department: '' })  
  const apiUrl = "https://5dfb299538678a00145faa47.mockapi.io/employee";  
  const Registration = (e) => {  
    e.preventDefault();  
    // debugger;  
    const data1 = {Id:data.Id, Email: data.Email, Password: data.Password, EmployeeName: data.EmployeeName, City: data.City, Department: data.Department };  
